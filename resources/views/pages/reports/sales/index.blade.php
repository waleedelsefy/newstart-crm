                                ...
                                <div class="uploads">
                                    <a
                                        ...
                                        <p class="font-weight-bold font-medium-2 mb-0">
                                            {{ $user->leadsAssignedToYouAndYourTeamsMembers()->count() }}
                                        </p>
                            ...
                            <div class="accordion" id="accordionExample" data-toggle-hover="true">
                                <div class="collapse-margin">
                                    <div class="card-header"
                                        ...
                                        <x-badges.primary text="{{ $user->events->count() }}" />
                                    </div>
                                    ...
                                    <div id="his-events-{{ Illuminate\Support\Str::slug($user->username) }}"
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center flex-wrap" style="gap: 5px">
                                                @foreach ($user->eventsReport() as $event)
                                                    <a href="{{ route('leads.index', ['assigned_to_users[0]' => $user->id, 'events_ids[0]' => $event->event_name]) }}"
                                ...
                                @if ($user->teamsILead->count())
                                    ...
                                    <div class="collapse-margin">
                                        <div class="card-header" id="team-{{ $username_prefix }}" data-toggle="collapse"
                                            ...
                                            <x-badges.primary text="{{ $user->eventsOnMyTeamsMembersLeads->count() }}" />
                                        </div>
                                        <div id="his-team-events-{{ $username_prefix }}" class="collapse"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center flex-wrap" style="gap: 5px">
                                                    @foreach ($user->eventsOnMyTeamsMembersLeadsReport() as $event)
