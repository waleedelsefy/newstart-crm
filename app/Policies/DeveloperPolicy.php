...
class DeveloperPolicy
{
    ...
    {
        return $user->hasPermissions(['view-any-developer']);
    }
    ...
    {
        return $user->hasPermissions(['view-developer']);
    }
    ...
    {
        return $user->hasPermissions(['create-developer']);
    }
    ...
    {
        return $user->hasPermissions(['update-developer']);
    }
    ...
    {
        return $user->hasPermissions(['delete-developer']);
    }
    ...
    {
        return $user->hasPermissions(['restore-developer']);
    }
    ...
    {
        return $user->hasPermissions(['force-delete-developer']);
    }
}
